...
export class Logger implements ILogger {
  ...
  private readonly ANSI_COLORS = {
    ...
    warn: "\x1b[33m",  // Yellow
    error: "\x1b[31m", // Red
    fatal: "\x1b[35m\x1b[1m", // Bold Magenta
    category: "\x1b[34m" // Blue
  };
  ...
  private log(
    ...
    // Write to console with formatting if allowed
    ...
    for (const sub of this.subscribers) {
      try {
        ...
        // Prevent subscriber failures from throwing inside the logger loop
      }
    }
  }
  ...
  private writeToConsole(entry: LogEntry): void {
    ...
    // Check if running in a browser console or shell terminal for coloring support
